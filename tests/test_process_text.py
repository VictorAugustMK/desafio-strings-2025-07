...
def setup_and_teardown():
    ...
    # Remove the comments if you want to delete the test files
...
def test_process_file():
    ...
    test_file.write_text("Lorem ipsum dolor sit amet, consectetur adipiscing elit, "
                         "sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", encoding="utf-8")

    lines = process_text_file("test.txt", width=40)

    output_file = OUTPUT_DIR / "test.txt_quebrado.txt"
